...
namespace assignment4
{
	...
	void TestDeleteRootNode()
	{
		...
		rootNode = tree.GetRootNode().lock();
		assert(*rootNode->Data == 11);
		assert(tree.Delete(*rootNode->Data));
